...
OUR_PROCESS = shell(
    ...
    <div class="process-detail" id="build">
      ...
      <p class="step-timing">Starter ~20 business days · Growth &amp; Pro per site plan</p>
      <p>Design and development in check-ins so there are no surprises at handover. Starter runs 10 days working draft, then 10 days unlimited revisions. Larger projects follow the timeline in your site plan.</p>
      <div class="scope-grid">
        <div class="scope-card included">
          <h3>What's included</h3>
          <ul class="scope-list">
