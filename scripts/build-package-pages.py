...
STARTER = shell(
    ...
    "Starter tier 1 website package — home, contact, and privacy included, plus up to 5 additional pages (8 total). Mobile-first design, lead capture, SEO setup, domain and going live included. $499 · $25 deposit (5%).",
    "starter",
    """    <div class="page-hero">
      <span class="mono label">Build package · Tier 1 · AUD</span>
      <h1>Starter — get found, get contacted</h1>
      <p class="lead">A solid foundation for businesses ready to be discovered online. Home, contact, and privacy included — plus up to 5 additional pages (8 total) — with mobile-first design, enquiry capture, and search setup. Domain registration and going live included.</p>
    </div>
    ...
    <div class="scope-grid">
      <div class="scope-card included">
        ...
        <ul class="scope-list">
          ...
          <li>Up to 5 additional pages (e.g. services, about, FAQs, and more)</li>
      ...
      <div class="scope-card not-included">
        ...
        <ul class="scope-list">
          <li>Pages beyond the 8-page allowance (available as an extra)</li>
    ...
    <ul>
      ...
      <li>Need home, contact, and privacy covered from day one</li>
    </ul>
...
GROWTH = shell(
    ...
    <div class="scope-grid">
      <div class="scope-card included">
        ...
        <ul class="scope-list">
          ...
          <li>Expanded page layouts beyond Starter's 8-page allowance</li>
    ...
    <ul>
      ...
      <li>Need more than 8 pages but not a full custom platform</li>
    </ul>
